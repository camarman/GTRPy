...
from display.display3D.coordinates import coordinates3d
from display.display3D.fieldsGUI import *
...
def grtc_gui3d(coordinate_type='Spherical Coordinates'):
    ...
    GRTensors_col1 = [
                            [sg.Button('Metric Tensor', button_color='purple'),
                             sg.Image(r'display/display3D/input_images/metrictensor.png')],
                            [sg.Button('Inverse Metric Tensor', button_color='purple'),
                             sg.Image(r'display/display3D/input_images/inversemetrictensor.png')],
                            [sg.Button('Christoffel Symbol', button_color='purple'),
                             sg.Image(r'display/display3D/input_images/chrissymbol.png')],
                            [sg.Button('Riemann Tensor', button_color='purple'),
                             sg.Image(r'display/display3D/input_images/riemanntensor.png')],
                            [sg.Button('Ricci Tensor', button_color='purple'),
                             sg.Image(r'display/display3D/input_images/riccitensor.png')]
                        ]

    GRTensors_col2 = [
                        [sg.Button('Ricci Scalar', button_color='purple'),
                            sg.Image(r'display/display3D/input_images/ricciscalar.png')],
                        [sg.Button('Weyl Tensor', button_color='purple'),
                            sg.Image(r'display/display3D/input_images/weyltensor.png')],
                        [sg.Button('Traceless Ricci Tensor', button_color='purple'),
                            sg.Image(r'display/display3D/input_images/tracelessriccitensor.png')],
                        [sg.Button('Einstein Tensor', button_color='purple'),
                            sg.Image(r'display/display3D/input_images/einsteintensor.png')],
                        [sg.Button('Kretschmann Scalar', button_color='purple'),
                            sg.Image(r'display/display3D/input_images/kretschmannscalar.png')]
                    ]

    Fields_col1 = [
                    [sg.Button('Scalar Field', button_color='purple'),
                        sg.Image(r'display/display3D/input_images/scalarfield.png')],
    ...
    Fields_col2 = [
                    [sg.Button('Type (2,0) Tensor Field', button_color='purple'),
                        sg.Image(r'display/display3D/input_images/tensorfield_20.png')],
                    [sg.Button('Type (1,1) Tensor Field', button_color='purple'),
                        sg.Image(r'display/display3D/input_images/tensorfield_11.png')],
                    [sg.Button('Type (0,2) Tensor Field', button_color='purple'),
                        sg.Image(r'display/display3D/input_images/tensorfield_02.png')]
                ]
    ...
    layout_4dim = [
                    ...
                    [sg.Frame(layout = [
                        [sg.Image(r'display/display3D/input_images/g0b.png'),
                        ...
                        [sg.Image(r'display/display3D/input_images/g1b.png'),
                        ...
                        [sg.Image(r'display/display3D/input_images/g2b.png'),
