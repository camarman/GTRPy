...
def vectorfield_gui3d(event, metric_tensor, coord_sys):
    ...
    if event == 'Type (1,0) Vector Field':
        vector_field_10_layout = [
                                        [sg.Image(r'display/display3D/input_images/vectorfield_10_0.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                        [sg.Image(r'display/display3D/input_images/vectorfield_10_1.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                        [sg.Image(r'display/display3D/input_images/vectorfield_10_2.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],

                                        [sg.Frame(layout=[
                                            [sg.Button('Calculate', button_color='purple'),
                                            sg.Image(r'display/display3D/input_images/vectorfield_01.png')
                                            ]], title='Vary Type', font=('Verdana', 12))],

                                        [sg.Frame(layout=[
                                            [sg.Button('Calculate', button_color='purple'),
                                            sg.Image(r'display/display3D/input_images/cov_vectorfield_10.png'),
                                        ...
                                        [sg.Frame(layout=[
                                            ...
                                            sg.InputText(default_text='0', font=('Tahoma', 11))],
                                            [sg.Button('Calculate', button_color='purple'),
                                            sg.Image(r'display/display3D/input_images/LX_vectorfield_10.png')]], title='Lie Derivative', font=('Verdana', 12))]
                                    ]
        ...
        while True:
            ...
            if event == sg.WIN_CLOSED or event == 'Exit':
                ...
                if event =='Calculate':
                    ...
                    preview(vry_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/vry_vector_field_10.png', euler=True,
                    ...
                    layout_vry_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/vry_vector_field_10.png')],
                                                    ]
                ...
                if event == 'Calculate0':
                    ...
                    preview(cd_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/cd_vector_field_10.png', euler=True,
                            dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                    resize_cd_image3d('Type (1,0) Vector Field')
                    layout_cd_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/cd_vector_field_10.png')],
                                                    ]
                ...
                # Calculation of the lie derivative
                    ...
                    preview(ld_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/ld_vector_field_10.png', euler=True,
                            dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                    resize_ld_image3d('Type (1,0) Vector Field')
                    layout_ld_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/ld_vector_field_10.png')],
                                                    ]
        ...
        vector_field_01_layout = [
                                    [sg.Image(r'display/display3D/input_images/vectorfield_01_0.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'display/display3D/input_images/vectorfield_01_1.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'display/display3D/input_images/vectorfield_01_2.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],

                                    [sg.Frame(layout=[
                                            [sg.Button('Calculate', button_color='purple'),
                                            sg.Image(r'display/display3D/input_images/vectorfield_10.png')
                                            ]], title='Vary Type', font=('Verdana', 12))],

                                    [sg.Frame(layout=[
                                        [sg.Button('Calculate', button_color='purple'),
                                        sg.Image(r'display/display3D/input_images/cov_vectorfield_01.png'),
                                        sg.Text('for', font=('Verdana', 11)),
                                        sg.Image(r'display/display3D/input_images/e.png'),
                                        sg.InputCombo(coord_sys, default_value=coord_sys[0])
                                        ]], title='Covariant Derivative', font=('Verdana', 12))],
                                    ...
                                    [sg.Frame(layout=[
                                        ...
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                        [sg.Button('Calculate', button_color='purple'),
                                        sg.Image(r'display/display3D/input_images/LX_vectorfield_01.png')]], title='Lie Derivative', font=('Verdana', 12))]
                                ]
        ...
        while True:
            ...
            if event == sg.WIN_CLOSED or event == 'Exit':
                ...
                if event =='Calculate':
                    ...
                    preview(vry_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/vry_vector_field_01.png', euler=True,
                            dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                    resize_vry_image3d('Type (0,1) Vector Field')
                    layout_vry_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/vry_vector_field_01.png')],
                                                    ]
                    window_vry_vector_field_result = sg.Window('Vector Field', layout_vry_vector_field_result)
                    while True:
                        event, values = window_vry_vector_field_result.read()
                ...
                if event == 'Calculate0':
                    ...
                    preview(cd_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/cd_vector_field_01.png', euler=True,
                            dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                    resize_cd_image3d('Type (0,1) Vector Field')
                    layout_cd_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/cd_vector_field_01.png')],
                                                    ]
                    window_cd_vector_field_result = sg.Window('Vector Field', layout_cd_vector_field_result)
                    while True:
                        event, values = window_cd_vector_field_result.read()
                ...
                # Calculation of the lie derivative
                    ...
                    preview(ld_vector_field_eqn, viewer='file', filename=r'display/display3D/output_images/ld_vector_field_01.png', euler=True,
                            dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                    resize_ld_image3d('Type (0,1) Vector Field')
                    layout_ld_vector_field_result = [
                                                        [sg.Image(r'display/display3D/output_images/ld_vector_field_01.png')],
                                                    ]
                    window_ld_vector_field_result = sg.Window('Vector Field', layout_ld_vector_field_result)
                    while True:
                        event, values = window_ld_vector_field_result.read()
