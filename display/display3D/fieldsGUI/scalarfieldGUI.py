    ...
    scalar_field_layout = [
                                ...
                                [sg.Frame(layout=[
                                    [sg.Button('Calculate', button_color='purple'),
                                     sg.Image(r'display/display3D/input_images/cov_scalarfield.png'),
                                ...
                                [sg.Frame(layout=[
                                    ...
                                    [sg.Image(r'display/display3D/input_images/LX2.png'),
                                     sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Button('Calculate', button_color='purple'),
                                     sg.Image(r'display/display3D/input_images/LX_scalarfield.png')]], title='Lie Derivative', font=('Verdana', 12))]
                                ]
    ...
    while True:
        ...
        if event == sg.WIN_CLOSED or event == 'Exit':
            ...
            if event == 'Calculate':
                ...
                preview(cd_scalar_field_eqn, viewer='file', filename=r'display/display3D/output_images/cd_scalar_field.png', euler=True,
                        dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                resize_cd_image3d ('Scalar Field')
                layout_cd_scalar_field_result = [
                                                    [sg.Image(r'display/display3D/output_images/cd_scalar_field.png')],
                                                ]
            ...
            if event == 'Calculate0':
                ...
                preview(ld_scalar_field_eqn, viewer='file', filename=r'display/display3D/output_images/ld_scalar_field.png', euler=True,
                        dvioptions=['-T', 'tight', '-z', '0', '--truecolor', '-D 1200', '-bg', 'Transparent'])
                resize_ld_image3d('Scalar Field')
                layout_ld_scalar_field_result = [
                                                    [sg.Image(r'display/display3D/output_images/ld_scalar_field.png')],
                                                ]
