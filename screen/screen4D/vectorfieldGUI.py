...
from equations.vectorfieldEP import *
...
def vectorfield_gui4d(event, metric_tensor, coord_sys):
    ...
    if event == 'Type (1,0) Vector Field':
        vector_field_10_layout = [
                                    [sg.Image(r'res/images4D/vectorfield_10_0.png'),
                                    sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_10_1.png'),
                                    sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_10_2.png'),
                                    sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_10_3.png'),
                                    sg.InputText(default_text='0', font=('Tahoma', 11))],
        ...
        vector_field_01_layout = [
                                    [sg.Image(r'res/images4D/vectorfield_01_0.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_01_1.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_01_2.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
                                    [sg.Image(r'res/images4D/vectorfield_01_3.png'),
                                        sg.InputText(default_text='0', font=('Tahoma', 11))],
