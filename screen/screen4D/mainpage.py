...
from screen.screen4D.coordinates import coordinates4d
from screen.screen4D.scalarfieldGUI import *
from screen.screen4D.vectorfieldGUI import *
from screen.screen4D.tensorfieldGUI import *
...
def grtc_gui4d(coordinate_type='Spherical Coordinates'):
    ...
    GRTensors_col1 = [
                        [sg.Button('Metric Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/metrictensor.png')],
                        [sg.Button('Inverse Metric Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/inversemetrictensor.png')],
                        [sg.Button('Christoffel Symbol', button_color='purple'),
                            sg.Image(r'res/images4D/chrissymbol.png')],
                        [sg.Button('Riemann Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/riemanntensor.png')],
                        [sg.Button('Ricci Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/riccitensor.png')]
                        ]

    GRTensors_col2 = [
                        [sg.Button('Ricci Scalar', button_color='purple'),
                            sg.Image(r'res/images4D/ricciscalar.png')],
                        [sg.Button('Weyl Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/weyltensor.png')],
                        [sg.Button('Traceless Ricci Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/tracelessriccitensor.png')],
                        [sg.Button('Einstein Tensor', button_color='purple'),
                            sg.Image(r'res/images4D/einsteintensor.png')],
                        [sg.Button('Kretschmann Scalar', button_color='purple'),
                            sg.Image(r'res/images4D/kretschmannscalar.png')]
                    ]

    Fields_col1 = [
                    [sg.Button('Scalar Field', button_color='purple'),
                        sg.Image(r'res/images4D/scalarfield.png')],
    ...
    Fields_col2 = [
                    [sg.Button('Type (2,0) Tensor Field', button_color='purple'),
                        sg.Image(r'res/images4D/tensorfield_20.png')],
                    [sg.Button('Type (1,1) Tensor Field', button_color='purple'),
                        sg.Image(r'res/images4D/tensorfield_11.png')],
                    [sg.Button('Type (0,2) Tensor Field', button_color='purple'),
                        sg.Image(r'res/images4D/tensorfield_02.png')]
                ]
    ...
    layout_4dim = [
                    ...
                    [sg.Frame(layout = [
                        [sg.Image(r'res/images4D/g0beta.png'),
                        ...
                        [sg.Image(r'res/images4D/g1beta.png'),
                        ...
                        [sg.Image(r'res/images4D/g2beta.png'),
                        ...
                        [sg.Image(r'res/images4D/g3beta.png'),
