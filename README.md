...
GRTC-GUI allows you to calculate the well-known tensors in general relativity, without writing a single line of code. In addition, you can apply many operations to 6 different type of fields. It's tested for GNU/Linux but it should also work in Windows and Mac. If you encounter a problem, feel free to create an issue.
