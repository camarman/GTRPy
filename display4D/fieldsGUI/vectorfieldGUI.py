        ...
        while True:
            ...
            if event == sg.WIN_CLOSED or event == 'Exit':
                ...
                if event == 'Calculate':
                    ...
                    preview(vry_vector_field_eqn, viewer='file', filename=r'display4D/output images/vry_vector_field_10.png', euler=True,
                    ...
                    layout_vry_vector_field_result = [
                                                        [sg.Image(r'display4D/output images/vry_vector_field_10.png')],
                                                    ]
